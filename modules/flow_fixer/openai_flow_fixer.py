...
class OpenAIFlowFixer(BaseFlowFixer):
    ...
    def improve_flow(
        ...
        LOGGER.debug(
            "Flow fixer (OpenAI): improve_flow request n_prev=%s n_new=%s new_lines=%s",
            n_prev,
            n_new,
        ...
        LOGGER.debug("Flow fixer (OpenAI): applied revisions n_prev=%d n_new=%d", n_prev_used, n_new_used)
